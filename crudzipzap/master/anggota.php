          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="<?php $_SERVER[SCRIPT_NAME];?>?page=checkout">
                <i class="fa fa-user"></i> <span>Check Out</span>  
              </a>
            </li>  
            <li>
            ...
            <div class="box-body">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php $_SERVER[SCRIPT_NAME] ;?>?page=anggota&id_anggota=<?php echo $row['id'];?>" class="btn btn-info"><li class="fa fa-pencil"></li> Edit</a> 
                                <a href="aksi.php?sender=hapus&id=<?php echo $row['id_anggota']; ?>" class="btn btn-danger"><li class="fa fa-trash-o"></li> Hapus</a> 
                             </td>
                        </tr> 
                            <?php    
                    $no++;                    
